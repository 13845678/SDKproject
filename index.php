	...
	<div id="main">
		<div id="head">
            <dl class="alipay_link">
                <a target="_blank" href="http://pay.700b.cn/"><span>免签约申请地址</span></a>
            </dl>
            <span class="title">新科支付免签约即时到账</span>
		</div>
        ...
        <div id="foot">
			<ul class="foot-ul">
				...
				<li>
				<p style="font-size: 100px;margin-top:40px">本页面请自行美化</p>
				</li>
			</ul>
		</div>
	</div>
